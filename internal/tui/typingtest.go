...
// defaultWords is loaded from embedded text files in wordlists.go
// Sources:
// - english_common.txt: Google 10000 English words (no swears)
// - eff_words.txt: EFF large word list
// - programming.txt: Programming and technology terms
// Run `make update-wordlists` to refresh from upstream sources
